// material 3 dialog service for consistent prompts

import 'package:flutter/material.dart';
import 'package:scorecard/theme/colors.dart';

/// provides material 3 compliant dialogs throughout the app
class DialogService {
  ...
  /// shows a team name edit dialog with duplicate validation
  static Future<String?> showTeamNameDialog({
    ...
    String? validateTeamName(String? value) {
      ...
      // Allow keeping same name, but prevent using other existing team names
